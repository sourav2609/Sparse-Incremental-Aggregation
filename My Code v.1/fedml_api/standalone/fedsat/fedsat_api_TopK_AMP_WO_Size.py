        ...
        for comm_round in range(self.args.comm_round):
            ...
            for i_sat, client2 in enumerate(self.client_list):
                if i_sat in satellite_idxes_in_orbit:
                       ...
                       #if i_sat == 31:
                       #   print(f"111 gradient_sat = {gradient_sat['linear.bias'][0]}") 
                       #   print(f"222 w_residual_user = {w_residual_user['linear.bias'][0]}")
                       if self.approach == 'TopK':
                             ...
                             n_AMP = 0
                              ...
                              #if  i_sat == 31:
                              #     print(f"##w_sparsified1 = {len(w_sparsified)}")
                              #print(f"##w_sparsified = {w_sparsified}")
                       #if i_sat == 31:
                       #   print(f"333 w_residual_new['weight.bias'][0] = {w_residual_new['linear.bias'][0]}")       
                       #   print(f"444 w_sparsified['weight.bias'][0] = {w_sparsified['linear.bias'][0]}")         
