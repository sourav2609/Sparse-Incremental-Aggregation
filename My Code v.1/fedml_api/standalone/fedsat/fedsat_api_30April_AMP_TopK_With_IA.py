...
class fedsat(object):
    ...
    def train(self):
        ...
        self._local_test_on_all_clients(0, 0,  x_axes = "round")
        for comm_round in range(self.args.comm_round):
            ...
            if comm_round % self.args.frequency_of_the_test == 0:
               if self.approach == 'AMP':
                        self._local_test_on_all_clients(comm_round+1, size_data_AMP_method, x_axes = "round")
               elif self.approach == 'TopK':
                        self._local_test_on_all_clients(comm_round+1, size_data_TopK_method, x_axes = "round")                        
    ...
    def _local_test_on_all_clients(self, idx, size_data, x_axes):
        ...
        wandb.log({"Test/Acc": test_acc, "round": idx, "Size_each_orbit": size_data})
        wandb.log({"Test/Loss": test_loss, "round": idx, "Size_each_orbit": size_data})
