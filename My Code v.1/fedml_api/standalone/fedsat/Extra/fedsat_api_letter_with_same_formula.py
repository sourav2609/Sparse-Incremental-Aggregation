...
class fedsat(object):
    ...
    def _aggregate(self, w_locals, w_local_before, w_global_temp, satellite_idxes_in_orbit, comm_round, index_presence_sat_old, index_presence_sat_new):
        ...
        (sample_num_new, averaged_params_old) = w_local_before[satellite_idxes_in_orbit[0]]

        for k in averaged_params_old.keys():
            temp_sum_2 = 0
            for i2 in satellite_idxes_in_orbit:

                     (local_sample_number, local_model_params) = w_local_before[i2]
                     temp_sum_2 += 1
                     w = (local_sample_number) / training_num
                     if temp_sum_2 == 1:
        ...
        print(f"@@@w_global_temp_new = {w_global_temp_new}")
