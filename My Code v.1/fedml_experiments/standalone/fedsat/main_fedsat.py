...
from fedml_api.standalone.fedsat.fedsat_api import fedsat
...
if __name__ == "__main__":
    ...
    wandb.init(project="FedISL_Sparsification", name="FedISL_Async" + ",-lr = " + str(args.lr)
    ...
    fedavgPlannedAsync_withoutaug = fedsat(dataset, device, args, model_trainer, initial_weights_matrix)    #for multi-initial-weight
