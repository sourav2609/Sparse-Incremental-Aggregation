...
from fedml_api.standalone.fedavgPlannedAsync.fedavgPlannedAsync_api import FedAvgPlannedAsync
...
if __name__ == "__main__":
    ...
    parser = add_args(argparse.ArgumentParser(description='fedavgPlannedAsync-standalone'))
    args = parser.parse_args()
    logger.info(args)
    device = torch.device("cuda" + str(args.gpu) if torch.cuda.is_available() else "cpu")
    logger.info(device)
    #wandb.init(mode="offline", project="results_fed_sat", name="fedavgPlannedAsync"  + "-lr" + str(args.lr)+ " ,Data: " + str(args.dataset),config=args)
    #wandb.init(project="LEOsats_schemes")
    #wandb.init(project="LEOsats_schemes", name="ffedavgPlannedAsyncc" + ",-lr = " + str(args.lr)
    #+ ", Data = " + str(args.dataset)+ " ,Num_satellites = " +str(args.client_num_per_round),config=args)
    wandb.init( project="LEOsats_schemes", name="fedavgPlannedAsync" + ",-lr = " + str(args.lr),config=args)
    ...
    FedAvgPlannedAsync = FedAvgPlannedAsync(dataset, device, args, model_trainer, initial_weights_matrix)   #for multi-initial-weight
    FedAvgPlannedAsync.train()
