...
var = input("Enter algorithm (Baseline, SIA, RE_SIA, CL_SIA, TC_SIA, RE_TC_SIA, CL_TC_SIA) = ")
#print(f"var = {var}")
if var == "Baseline":
...
if __name__ == "__main__":
    ...
    wandb.init( project="23May2024", name="FedAVG" + ",-lr = " + str(args.lr) + "_numNodes = " + str(args.client_num_in_total) + "BatchSize = 20" + "_comRounds = " + str(args.comm_round) + "_algo = "+ var + "_q = " + str(args.spar_ratio),config=args)
