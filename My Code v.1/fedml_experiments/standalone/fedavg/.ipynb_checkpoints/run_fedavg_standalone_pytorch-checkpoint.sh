...
#sh run_fedavg_standalone_pytorch.sh 1 20 20 30 shakespeare ./../../../data/shakespeare rnn hetero 50 5 0.03 sgd 1
#sh run_fedavg_standalone_pytorch.sh 1 10 10 128 shakespeare ./../../../data/shakespeare rnn hetero 50 5 0.03 sgd 1
