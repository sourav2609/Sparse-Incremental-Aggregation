...
from fedml_api.standalone.fedavg_satellite.fedavg_satellite_api import FedAvg_satellite
...
def load_data(args, dataset_name):
    ...
    if dataset_name == "mnist":
        ...
        we uniformly sample a fraction of clients each round (as the original fedavg_satellite paper)
        """
...
if __name__ == "__main__":
    ...
    parser = add_args(argparse.ArgumentParser(description='fedavg_satellite-standalone'))
    ...
    #device = torch.device("cuda")
    logger.info(device)
    #wandb.init(mode="offline", project="results_fed_sat", name="FedAVG_satellite" +  " ,lr: " + str(args.lr)+ " ,Data: " + str(args.dataset), config=args)

    wandb.init(project="LEOsats_schemes", name="fedavg_satellite" + " , -lr = " + str(args.lr)
    ...
    fedavg_satellite= FedAvg_satellite(dataset, device, args, model_trainer, initial_weights_matrix)
    fedavg_satellite.train()
