...
if __name__ == "__main__":
    ...
    logger.info(device)
    wandb.init(project="LEOsats_schemes", name="fedavgPlannedAsync_withoutaug" + ",-lr = " + str(args.lr)
    ...
    fedavgPlannedAsync_withoutaug = fedavgPlannedAsync_withoutaug(dataset, device, args, model_trainer, initial_weights_matrix)    #for multi-initial-weight
