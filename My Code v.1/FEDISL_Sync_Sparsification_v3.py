    ...
    def dispatcher(self, first_operation_queue, time_now, time_operation, vector_time_start, vector_time_end, max_value, idx_orbit):
        ...
        if first_operation_queue == 'transmit from GEO to LEO':
            ...
            if time_now != None:
                 ...
                 #print(int(np.ceil(len(vector_time_start) / 2)))
...
if Data_type == 'MNIST':
        ...
        if inc>60:
          if parameter_server == 'BR-GS':
             with open('./Results/Time_FedISL_Sync_MNIST_Bremen_walker_star.py', 'w') as f:
        ...
        if inc>60:
          if parameter_server == 'BR-GS':
             with open('./Results/Time_FedISL_Sync_CIFAR10_Bremen_walker_star.py', 'w') as f:
                f.write(f'Time_FedISL_Sync_Bremen =  {TIME_AGGREGATE}')
