...
from fedml_api.standalone.fedavgPlannedAsync_withoutaug.fedavgPlannedAsync_withoutaug_api import fedavgPlannedAsync_withoutaug
...
def add_args(parser):
    ...
    parser.add_argument('--N_sp', type=int, default=4,
...
if __name__ == "__main__":
    ...
    parser = add_args(argparse.ArgumentParser(description='fedavgPlannedAsync_withoutaug-standalone'))
    ...
    #torch.manual_seed(0)
    #print('check exactly after manual_seed')
    ...
    # In this case, please use our FedML distributed version (./fedml_experiments/distributed_fedavgPlannedAsync_withoutaug)
    ...
    fedavgPlannedAsync_withoutaug = fedavgPlannedAsync_withoutaug(dataset, device, args, model_trainer)
    #logging.info(fedavgPlannedAsync_withoutaug)
    fedavgPlannedAsync_withoutaug.train()
    #logging.info(fedavgPlannedAsync_withoutaug.train())
