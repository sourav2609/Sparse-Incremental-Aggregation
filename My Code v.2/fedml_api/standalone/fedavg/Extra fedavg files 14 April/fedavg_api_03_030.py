...
class FedAvgAPI(object):
    def __init__(self, dataset, device, args, model_trainer):
        ...
        self.p = 0.01
        self.AMP_TopK = [True, False] # % The first entry: AMP algorithm and the second entry: TopK
        self.test_acc_Sync = []
    ...
    def train(self):
        ...
        round_idx = 0
        self._local_test_on_all_clients(round_idx, 0, 0)    # (round_idx, size_bit, size_data_spar_method)
        for round_idx in range(1, self.args.comm_round):
            ...
            for idx, client in enumerate(self.client_list):
                ...
                w = client.train(w_global_temp_to_train)
