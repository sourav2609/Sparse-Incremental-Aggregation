...
class FedAvgAPI(object):
   ...
   def train(self):
        ...
        round_idx = 0
        self._local_test_on_all_clients(round_idx, 0)    # (round_idx, size_bit, size_data_TopK_method)
        for round_idx in range(1, self.args.comm_round):
            ...
            print(f"count_non_zero_elements(self, AMP_all_entries) = {self.count_non_zero_elements(vectors_local_Spar)}")
   ...
   def _local_test_on_all_clients(self, round_idx, size_data_TopK_method):
