   ...
   def train(self):
        ...
        for round_idx in range(1, self.args.comm_round):
            ...
            for idx, client in enumerate(self.client_list):
                ...
                w_wo_sparsification = copy.deepcopy(model_new)
                ...
                if self.AMP_TopK[0] == False and self.AMP_TopK[1] == True:
                    ...
                    w_residual_user = copy.deepcopy(w_global)
                    for key_idx in range(len(residual)):
                        values_key_idx = list(residual.values())[key_idx]
                        zeros_key_idx = torch.zeros(values_key_idx.shape)
                        w_residual_user[list(residual.keys())[key_idx]] = zeros_key_idx

                    #if idx == 3:
                    #     print(f"$$$$$$$$$$w_wo_sparsification = {w_wo_sparsification}")
            ...
            #print(f"count_non_zero_elements(self, AMP_all_entries) = {self.count_non_zero_elements(AMP_all)}")
