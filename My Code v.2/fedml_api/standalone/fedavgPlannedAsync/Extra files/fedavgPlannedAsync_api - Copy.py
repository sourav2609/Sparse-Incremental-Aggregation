...
class FedAvgPlannedAsync(object):
    ...
    def _aggregate(self, w_locals):
            ...
            print(f"time_period_weight = {time_period_weight}")
            print(f"number_participated_satellite = {number_participated_satellite}")
            time_period_weight = (time_period_weight/number_participated_satellite) #(1/T1+1/T2)/K
            #time_period_weight = (time_period_weight) #(1/T1+1/T2)/K
    ...
    def _local_test_on_all_clients(self, idx, x_axes):
        ...
        print(f"{len(self.test_acc_round)}")
        ...
        if x_axes=="time":
            ...
            wandb.log({"Test/Acc": test_acc, "satellites_GS_time (seconds)": idx})
