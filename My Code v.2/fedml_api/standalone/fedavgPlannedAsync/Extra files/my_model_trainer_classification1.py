        ...
        for epoch in range(args.epochs):
            ...
            for batch_idx, (x, labels) in enumerate(train_data):
                ...
                for param in model.parameters():
                   x1 = copy.deepcopy(param.grad)
                   x2 = x1.detach().numpy()
                   gradients_all[iiii].append(x2)
                   iiii += 1
            ...
            counter = 0
            for idxx in range(len(gradients_all)):
                meann_gradients = np.mean(gradients_all[idxx], 0)
                gradientt[list(gradientt.keys())[idxx]] = meann_gradients
